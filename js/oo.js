(function ($, window, document, undefined) {
    ...
    Owl.prototype.animate = function (coordinate) {
        ...
        if (this.support3d) {
            ...
            this.$stage.animate({left: coordinate}, this.speed() / 1e3, this.settings.fallbackEasing, $.proxy(function () {
...
jQuery(document).ready(function () {
    if (jQuery("#promo-images-300").length > 0) {
        jQuery("#promo-images-300").owlCarousel({
            ...
            responsive: {
                0: {items: 1, nav: true},
                701: {items: 2, nav: false},
                991: {items: 3, nav: true},
                1e3: {items: 3, nav: true}
            }
        })
    }
    if (jQuery("#more-promos-300").length > 0) {
        jQuery("#more-promos-300").owlCarousel({
            loop: true,
            thumbs: false,
            thumbImage: false,
            margin: 0,
...
function nextstep(nexdivclass) {
    jQuery("html, body").animate({scrollTop: $("#" + nexdivclass).offset().top}, 500)
}